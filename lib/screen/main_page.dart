...
import 'package:cab/screen/SearchDropOfLocation.dart';
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: GestureDetector(
                                      onTap: () async {
                                        //go to search place
                                        var responseFromSearchScreen = await Navigator.push(context, MaterialPageRoute(builder: (c) => const SearchDropOfLocation()));
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        SizedBox(
                            ...
                            Text(
                              ...
                              style: GoogleFonts.niconne(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 15),
                            ),
                          )
                        ],
                      ),
