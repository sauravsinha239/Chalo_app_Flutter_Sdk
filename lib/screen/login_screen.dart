  ...
  void _Submit() async {
    if (_formkey.currentState!.validate()) {
      await firebaseAuth.signInWithEmailAndPassword(
        ...
        Navigator.push(context, MaterialPageRoute(builder:(x)=> const main_page()));
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration:  InputDecoration(
                            ...
                            prefixIcon: Icon(Icons.email_rounded,color: darktheme ? Colors.yellowAccent: Colors.red,)
                        ...
                        GestureDetector(
                          onTap: () {
                            Navigator.push(context,MaterialPageRoute(builder:  (c)=>const forgetScreen()));
                          },
                          child: Text(
                            'Forget Password',
                            style: TextStyle(
                        ...
                        GestureDetector(
                          onTap: () {
                                Navigator.push(context,MaterialPageRoute(builder:  (c)=>const register_screen()));
                          },
