...
class SearchDropOfLocation extends StatefulWidget{
  const SearchDropOfLocation({super.key});

  @override
  State<SearchDropOfLocation> createState() => _SearchDropOfLocationState();
}

class _SearchDropOfLocationState extends State<SearchDropOfLocation> {
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: "Search Location here...",
                                hintStyle: GoogleFonts.niconne(color: darkTheme ? Colors.red : Colors.green,
                                fontSize: 30),
